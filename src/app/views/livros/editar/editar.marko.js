...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/hello-world$1.0.0/src/app/views/livros/editar/editar.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>Cadastro de livros</h1><form action=\"/livros/update\" method=\"post\"><input type=\"hidden\" id=\"id\" name=\"id\" value=\"" +
...
marko_template.meta = {
    id: "/hello-world$1.0.0/src/app/views/livros/editar/editar.marko",
    tags: [
